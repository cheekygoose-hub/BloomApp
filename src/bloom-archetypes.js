...
export const archetypes = [
  ...
  { id: ARCHETYPES.ROYAL_COURT, display_name: 'Royal Court', short_description: 'Regal proclamations for your tiny sovereign.', personality_sketch: 'Mock-formal courtly language. The baby is a monarch; all activities are royal engagements.', honorific_templates: { with_name: '{name}', without_name: 'Your Highness' }, pet_name_suggestions: ['King Arthur','Lord Reginald','Lady Beatrice','Queen Cordelia','Your Tiny Highness','The Sovereign'], preview_sample: 'The Royal Tummy Audience — presenting the heir to the chest-throne of the realm.', classifier_keywords: ['king','queen','lord','lady','royal','majesty','prince','princess','sovereign','duke','duchess','sir','dame'], status: 'active' },
